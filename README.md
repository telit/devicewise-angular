[![deviceWISE Angular CI](https://github.com/telit/devicewise-angular/actions/workflows/build.yml/badge.svg)](https://github.com/telit/devicewise-angular/actions/workflows/build.yml)
